...
const STEEL = new THREE.MeshStandardMaterial({ color: '#344451', roughness: 0.52, metalness: 0.7 });
...
const CARTON = new THREE.MeshStandardMaterial({ color: '#8a6e42', roughness: 0.92, metalness: 0.02 });
