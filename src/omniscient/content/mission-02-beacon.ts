...
export const MISSION_02: MissionDefinition = {
  ...
  beats: [
    ...
    },
    {
      ...
      say:
        'Right. It is in.\n\n' +
        '...and out it goes again. Same as before.\n\n' +
        'I said it would not do it. You told me to put it in anyway and I did, because ' +
        'you are the one who is supposed to know. I am coming down - the harbour master ' +
        'can put a lamp on the wall tonight.',
      on: {},
      failure: {
        summary:
