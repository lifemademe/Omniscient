...
| **D-1** | Dioramas | Eight rooms, eight named lighting looks | §4.3 / §7 | `IN LOOP` claude 2026-08-27 | Seven of eight identifiable in greyscale (`captures/d1-now/sheet-grey.png`). **Repair shop taken through 6 critic rounds**: subject now -20 body / +86 face, a silhouette with a lit face, and the eye lands on her at r=24 and r=48 squint. Open at r=80, where the batten still takes coarse squint 73/27. `captures/p1.png`. Cleared house paused - see D-1c. Judge room 3 on a strip, never a still |
...
| **D-1c** | Dioramas | Cleared house: the subject has no lit field to stand against | §4.3 | `PAUSED` claude 2026-08-27 | **6 critic rounds, stopped on budget rather than on agreement.** Progress is real: her key lands (face 120), the table came down from 74% to 72% of the frame's highlights, and a door wash was added. Not closed - at a 40px blur she fuses into the black doorway behind her (12.0) and the frame reduces to a bright window, a bright tabletop and a dark column. The bar's figure is DARKER than its surround and still reads, because it is an unbroken silhouette on a continuously lit field. **This room's problem is composition, not exposure**: a table stands between camera and subject and occludes her at the waist, which no light can undo. `captures/p2.png` |
