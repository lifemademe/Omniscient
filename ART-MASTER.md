...
| **D-1b** | Dioramas | The repair shop's work lamp is not inside its own shade | §4.3 | `OPEN` | Light at (0.25, 1.55, -0.15), shade at (0.49, 1.41, -0.56) - 0.41m apart in z. Invisible until the shaft was hung off the light and drew haze in mid-air beside the fixture. Fix is to move the light, which moves a pool that took three measured rounds to settle |
