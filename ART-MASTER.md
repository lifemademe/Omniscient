...
| **W-1c** | Warehouse | Real darkness between the pools | `warehouse/02-high-bay-pools.jpg` | `IN LOOP` claude 2026-08-26 | r9: near-black 5.9% / p5 18 / median 60 / p95 136 / spread 118 / clip 0.0% against the bar's 5.0% / 20 / 78 / 127 / 107 / 0.0% — the shape of the range now lands, the median sits 18 low. Aisle floor swings 18.6..122 (314% of its own mean, from 73% at r2), which is the cadence this item is for. Address-plate contrast 109 levels, down from 181 but far above legible. Capture `scripts/dev/W1-r9-after.jpg`, commit 9c51c3e |
